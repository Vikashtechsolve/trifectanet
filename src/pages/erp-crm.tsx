...
import { Building2, Users, LineChart, Settings } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-white">
      <Hero
        title="ERP &"
        subtitle="CRM"
        description="Streamline your business operations and enhance customer relationships with our comprehensive ERP and CRM solutions that drive efficiency and growth."
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 md:mb-16">
            ...
            <p className="text-base md:text-lg text-gray-600 max-w-3xl mx-auto">
              Comprehensive ERP and CRM solutions tailored to meet your specific business needs and drive operational excellence
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 transition-all duration-300 hover:shadow-xl hover:-translate-y-2 border-t-4 border-[#0a3d62] overflow-hidden relative group h-full flex flex-col">
              ...
              <p className="text-base text-gray-600 relative z-10 leading-relaxed flex-grow">
                Seamless implementation of ERP systems to streamline your business processes and enhance operational efficiency.
              </p>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 transition-all duration-300 hover:shadow-xl hover:-translate-y-2 border-t-4 border-[#0a3d62] overflow-hidden relative group h-full flex flex-col">
              ...
              <p className="text-base text-gray-600 relative z-10 leading-relaxed flex-grow">
                Enhance customer relationships with comprehensive CRM solutions that drive engagement and loyalty.
              </p>
              <div className="absolute bottom-0 left-0 w-0 h-1 bg-[#f47847] group-hover:w-full transition-all duration-700 ease-out"></div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 transition-all duration-300 hover:shadow-xl hover:-translate-y-2 border-t-4 border-[#0a3d62] overflow-hidden relative group h-full flex flex-col">
              ...
              <h3 className="text-xl font-bold mb-4 text-[#0a3d62] group-hover:text-[#f47847] transition-colors duration-300">Business Analytics</h3>
              <p className="text-base text-gray-600 relative z-10 leading-relaxed flex-grow">
                Leverage data-driven insights to make informed business decisions and drive growth.
              </p>
              <div className="absolute bottom-0 left-0 w-0 h-1 bg-[#f47847] group-hover:w-full transition-all duration-700 ease-out"></div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 transition-all duration-300 hover:shadow-xl hover:-translate-y-2 border-t-4 border-[#0a3d62] overflow-hidden relative group h-full flex flex-col">
              ...
              <p className="text-base text-gray-600 relative z-10 leading-relaxed flex-grow">
                Seamlessly integrate your ERP and CRM systems with existing business applications for enhanced efficiency.
              </p>
              <div className="absolute bottom-0 left-0 w-0 h-1 bg-[#f47847] group-hover:w-full transition-all duration-700 ease-out"></div>
            </div>
          </div>
