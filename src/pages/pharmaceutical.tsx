  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
      ...
      <div className="order-2 self-center">
        ...
        <div className="space-y-4 md:space-y-6 max-w-prose text-justify text-gray-700">
          <p className="text-base md:text-lg leading-relaxed tracking-normal">
            Trifectanet is your trusted partner in the pharmaceutical industry, offering tailored IT solutions to address the sector's unique challenges. We understand the critical importance of accelerating drug development, maintaining regulatory compliance, and optimizing operations.
          </p>
          <p className="text-base md:text-lg leading-relaxed tracking-normal">
            Our suite of IT solutions empowers pharmaceutical companies to harness the full potential of data analytics, AI, and digital transformation. With Trifectanet by your side, you can expedite innovation, improve patient outcomes, and navigate the intricate landscape of pharmaceuticals with confidence.
          </p>
        </div>
      </div>
    </div>
