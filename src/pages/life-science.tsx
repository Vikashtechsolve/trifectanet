  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center">
      ...
      <div className="order-2 self-center">
        ...
        <div className="space-y-4 md:space-y-6 text-justify max-w-prose text-gray-700">
          <p className="text-base md:text-lg leading-relaxed">
            Trifectanet provides cutting-edge IT solutions designed specifically for the life sciences industry. Our expertise in data analytics, laboratory information management systems, and research workflow automation helps organizations streamline their operations and accelerate discoveries.
          </p>
          <p className="text-base md:text-lg leading-relaxed">
            We leverage advanced technologies such as AI, machine learning, and cloud computing to enable predictive analytics, automated data processing, and secure collaboration. With Trifectanet as your technology partner, you can focus on breakthrough research while we handle the technological infrastructure.
          </p>
        </div>
      </div>
    </div>
