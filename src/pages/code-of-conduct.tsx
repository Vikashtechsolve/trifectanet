          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center mb-16 md:mb-20"> {/* Added items-center, adjusted gap/margin */}
            ...
            <div className="order-1 md:order-2 flex flex-col justify-center"> {/* Text first on mobile, second on md+. Added flex justify-center */}
              ...
              <p className="text-base md:text-lg text-gray-700 mb-6 text-justify leading-relaxed"> {/* Justified text, responsive size, leading */}
                We, Trifecta Net, proudly align ourselves with the Responsible Business Alliance (RBA) Code of Conduct. This commitment extends throughout our ethos and operations, reflecting our steadfast commitment to environmental, social, and ethical standards in the electronics and technology industry.
              </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-8"> {/* Responsive columns and gap */}
              {[
                ...
                },
                {
                  ...
                  description: "Trifectanet is committed to continuous improvement in our ethical practices. We regularly assess our ethos and operations and identify areas for improvement, ensuring that our commitment to ethical business remains dynamic and effective.",
                  icon: "M13 6a3 3 0 11-6 0 3 3 0 016 0zM18 8a2 2 0 11-4 0 2 2 0 014 0zM14 15a4 4 0 00-8 0v3h8v-3zM6 8a2 2 0 11-4 0 2 2 0 014 0zM16 18v-3a5.972 5.972 0 00-.75-2.906A3.005 3.005 0 0119 15v3h-3zM4.75 12.094A5.973 5.973 0 004 15v3H1v-3a3 3 0 013.75-2.906z"
                },
                {
                  title: "Trust and Accountability",
                  description: "Trifectanets' commitment to ethical business practices and the RBA Code of Conduct underscores our commitment to building trust with our stakeholders. By upholding these standards, we prioritize accountability.",
