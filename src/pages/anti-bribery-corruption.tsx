        ...
        <div className="prose max-w-none">
          ...
          <section className="mb-10">
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              The principles and obligations outlined in this policy apply to all employees of Trifectanet Sdn Bhd, Board of Directors, and Trifectanet Sdn Bhd's stakeholders, which include customers, vendors, agents, consultants, outsourced personnel and other representatives
            </p>
            <p className="text-gray-600 leading-relaxed">
              This policy sets forth Trifectanet Sdn Bhd minimum compliance standards concerning interactions with third parties. However, where local law and regulations require more stringent controls, then such stricter controls must be followed.
            </p>
          </section>
          ...
          <section className="mb-10">
            ...
            <p className="text-gray-600 leading-relaxed">
              Employees are prohibited from, directly or indirectly, soliciting, accepting or obtaining or agreeing to accept or attempting to obtain, from any party for themselves or for any other party, any bribe or gratification as an inducement or a reward for doing or forbearing to do, or for having done or forborne to do, any act in relation to Trifectanet Sdn Bhd's affairs or business, or for showing favor or forbearing to show disfavor to any party in relation to Trifectanet Sdn Bhd's' affairs or business.
            </p>
          </section>
          ...
          <section className="mb-10">
            ...
            <p className="text-gray-600 leading-relaxed">
              Employees must not, directly or indirectly, receive or obtain, in respect of any goods or services purchased or other business transacted (whether or not by them) by or on behalf of Trifectanet Sdn Bhd, any discount, rebate, commission, service, interest, consideration of value or other benefit or payments of any kind (whether in cash or in kind) which is not authorised by Trifectanet Sdn Bhd's policies or procedures
            </p>
          </section>
          ...
          <section className="mb-10">
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              Trifectanet Sdn Bhd prohibits both the giving and receiving of Gifts, Entertainment and Travel (GET) and Donation and Sponsorship (D&S) to influence business decisions. Employees must comply with all applicable policies, procedures, laws and regulations related to the use of GET in all countries in which the Trifectanet operates
            </p>
            <p className="text-gray-600 leading-relaxed mb-4">
              Trifectanet Sdn Bhd allows appropriate business-related GET. Reasonable GET are acceptable provided that the following guiding Principles are observed:
            </p>
            <div className="pl-4">
          ...
          <section className="mb-10">
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-600 leading-relaxed">
                  Trifectanet Sdn Bhd does not make or offer monetary or in-kind political contributions to political parties, political party officials or candidates for political office.
                </p>
              </div>
              <div>
                ...
                <p className="text-gray-600 leading-relaxed mb-4">
                  In accordance with Trifectanet Sdn Bhd's commitment to contribute to the community coupled with its values of integrity and transparency, all sponsorships and donations must comply with the following:
                </p>
          ...
          <section className="mb-10">
            ...
            <p className="text-gray-600 leading-relaxed">
              Recognizing the abovementioned values, Trifectanet Sdn Bhd provides an avenue for all employees of Trifectanet Sdn Bhd, members of the public and stakeholders to disclose any improper conduct within Trifectanet Sdn Bhd
            </p>
          </section>
        </div>
      </div>
