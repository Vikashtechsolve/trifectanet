  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center">
      ...
      <div className="order-2 self-center">
        ...
        <div className="space-y-6 text-justify max-w-prose text-gray-700">
          <p className="text-base md:text-lg leading-relaxed">
            Trifectanet provides comprehensive IT solutions tailored to the automotive industry. Our expertise in manufacturing automation, connected vehicle technologies, and safety systems helps organizations optimize their operations and enhance vehicle performance.
          </p>
          <p className="text-base md:text-lg leading-relaxed">
            We leverage advanced technologies such as IoT, AI, and cloud computing to enable smart manufacturing, predictive maintenance, and enhanced vehicle connectivity. With Trifectanet as your technology partner, you can stay ahead of industry trends and deliver exceptional automotive experiences.
          </p>
        </div>
      </div>
    </div>
