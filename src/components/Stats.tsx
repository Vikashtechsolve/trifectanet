      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="w-full md:w-5/12 mb-10 md:mb-0 bg-[#072c4b] rounded-lg p-6 md:p-8">
            ...
            <div className="mt-6 text-center">
              <button 
                ...
                className="bg-[#072c4b] border border-[#f47847] text-[#f47847] hover:bg-[#f47847] hover:text-white transition-colors duration-300 px-4 py-2 rounded-full inline-flex items-center text-sm font-medium"
              >
          ...
          <div className="w-full md:w-7/12 md:pl-12">
            <h2 
              className="text-3xl md:text-4xl font-bold mb-6 text-[#f47847] cursor-pointer hover:text-[#f47847]/80 transition-colors"
              onClick={handleAboutClick}
            >
              About Us
            </h2>
            <p className="text-gray-300 mb-6 leading-relaxed">
              At Trifecta Net, we harness the power of technology and develop innovative solutions 
